...
| 变化 | 旧值 | 新值 | 新版引文（截断显示） |
|---|---|---|---|
| western.attitude_target | None | 自行用药行为（否定作用于行为，非药品本身） | 不建议自行长期服用 |
...
| 变化 | 旧值 | 新值 | 新版引文（截断显示） |
|---|---|---|---|
| western.attitude_target | None | 自行用药行为（否定作用于行为，非药品本身） | 不宜自行长期服用 |
...
| 变化 | 旧值 | 新值 | 新版引文（截断显示） |
|---|---|---|---|
| western.attitude_target | None | 自行用药行为（否定作用于行为，非药品本身） | 不建议自行服用 |
...
| 变化 | 旧值 | 新值 | 新版引文（截断显示） |
|---|---|---|---|
| western.attitude_target | None | 自行用药行为（否定作用于行为，非药品本身） | 不要自行服用 |
...
| tcm.attitude_target | None | 自行用药行为（否定作用于行为，非药品本身） | 不要轻信偏方：不要自行服用所谓的「溶栓偏方」「祖传中药」 |
