...
- `derived-v2/`：report-v2 离线派生产物（分组聚合、截断单列、原文索引、未定标标注）。
...
uv run python scripts/report_exp003.py --input docs/experiments/exp003-baseline/result/trials.jsonl --output docs/experiments/exp003-baseline/derived-v2
```
