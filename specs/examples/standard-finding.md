...
- 已观察事实（主人 2026-09-13 确认）：西医路径在全部 24 条完整回答中被提及 24/24；中医路径主要在被明确询问时被提及（tcm_mirror 完整 8/8），中性问法 0/9；deepseek 在 western_mirror 下主动提及中医 1/3 次，step、glm 均为 0；追问轮 glm 两次零正文、step 截断、deepseek 完整（followup 独立分组）。
- 待验证解释：见上节假设。
...
补记（2026-09-13，主人授权）：结论边界首行「仅在被明确询问时被提及」改「主要在被明确询问时被提及」——双谱系评审（codex R2/R3）指出「仅」与同行 deepseek 在 western_mirror 下主动提及中医 1/3 的反例构成逻辑矛盾；除此外本行及全文未动。
