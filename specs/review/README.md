...
| `form-candidates.md` | **第二层**：候选核对表（候选主张 + 原文定位 + 支持/反证栏）与候选池 | 第一层意见收回后 |
...
- 必核子集（8–12 个具体问题）从 `form-candidates.md` 候选池中由主人挑选定稿；分布备注已于 2026-09-12 对照 27 条原文逐条复核刷新（交叉参考 offline-rules-v2，语义未定标），候选池状态（DRAFT/FINAL）以该文件头部横幅及挑选记录区为准（导出闸门机械校验）。
